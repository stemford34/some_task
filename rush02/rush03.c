...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/09/09 20:43:51 by okovalch          #+#    #+#             */
/*   Updated: 2017/09/09 20:43:51 by okovalch         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include <unistd.h>

void	print_rush03(int x_size, int y_size, int x_count, int y_count);
...
void	put_rush_03(int x_size, int y_size)
{
	...
	{
		print_rush03(x_size, y_size, x_count, y_count);
		write(1, "\n", 1);
		++x_count;
	}
}
